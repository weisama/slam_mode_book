...
```
1.3d版雷达非水平放置需设置雷达放置位置参数组，设置教程见进阶使用第3节
2.如无需与px4飞控通信，或无需串口输出，可以设置0x11或0x12参数为不能，减少对应输出带来的算力占用
3.导航版需正确设置路径规划参数组：建议首次测试，建议最大移动速度和最大加速度默认100；规划出的轨迹不从障碍物中间穿过而是从上方经过，可以适当减小0x23最大高度和0x26安全距离
4.2d/3d导航版需正确设置0x25机器人半径和0x26安全距离，当前无人机位置或目标点与障碍物距离小于机器人半径则会规划失败；障碍物包括地板，所以3d导航版在地面测试路径规划失败，很可能是机器人中心距离地板小于设置的机器人半径，路径规划算法认为机器人在地板内则规划失败
5.2d导航版会强制在z=0x24起飞高度的平面内进行规划，故设置起飞高度=巡航高度
6.3d导航版会考虑z轴是否接触到障碍物
```
